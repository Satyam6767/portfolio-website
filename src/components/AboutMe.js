import aboutMeImg from "../images/profile-photo.jpeg"; 
...
const AboutMe = ({ name, email, location, availability }) => {
  ...
  const handleDownload = () => {
    ...
    link.href = resume;
    link.download = "satyam kumar - Resume.pdf";
    link.onload = () => {
      link.remove();
      setDownloading(false);
    };
        ...
        >
          <div className="contentContainer">
            ...
            <h5>
              ...
              from front-end design to back-end development.Also Interested in DSA solved more than 500 problems on various plateforms.
            </h5>
